...
function PostPresentation({
  ...
  return (
    <div className="flex flex-col place-content-center">
      <div className="flex my-4 ml-4 text-white border-l-2 rounded grow">
        <div className="flex flex-col h-full p-2 bg-gray-800 rounded">
          <UpVote
            direction="up"
            filled={
        ...
        <div className="grid w-full m-2">
          ...
          <p
            className="p-4 m-4 font-sans bg-gray-600 rounded"
...
function CommentView({
  ...
  return (
    <>
      <div className="flex my-4 ml-4 text-white border-l-2 rounded ">
        <div className="flex w-full grow">
          <div className="flex flex-col h-full p-2 bg-gray-800 rounded grow-0">
            <UpVote
              direction="up"
            ...
            />
            <p className="text-align: center">{score}</p>
            <UpVote
              direction="down"
          ...
          <div className="grid w-full grid-cols-1 my-2 ml-2 ">
            <p>
...
function CreateComment({
  ...
  return (
    <>
      <form
        className="flex flex-col justify-start gap-4 p-4 mx-4 border-2 rounded"
